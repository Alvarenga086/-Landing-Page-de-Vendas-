      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              Bolsas artesanais e peças em crochê feitas à mão com amor e dedicação. 
          ...
          <div>
            ...
            <nav className="flex flex-col gap-2">
              ...
              <a href="#entrega" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                Entrega
              </a>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a 
                ...
                className="inline-flex items-center justify-center w-10 h-10 bg-secondary rounded-full text-muted-foreground hover:text-primary hover:bg-primary/10 transition-colors"
                aria-label="Instagram"
              >
                <Instagram className="w-5 h-5" />
              </a>
              <a 
                href="https://wa.me/5586921427834" 
                target="_blank" 
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center w-10 h-10 bg-secondary rounded-full text-muted-foreground hover:text-primary hover:bg-primary/10 transition-colors"
                aria-label="WhatsApp"
        ...
        <div className="pt-8 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground">
            © {currentYear} D&apos;luz & Miçangas. Todos os direitos reservados.
          </p>
          <p className="text-sm text-muted-foreground">
