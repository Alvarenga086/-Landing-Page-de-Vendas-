        ...
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="hidden md:flex items-center gap-3">
            <a 
              ...
              className="inline-flex items-center justify-center w-11 h-11 rounded-full bg-secondary text-muted-foreground hover:text-primary hover:bg-primary/10 transition-colors"
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center w-11 h-11 rounded-full bg-[#25D366] text-white hover:opacity-90 transition-opacity"
              aria-label="WhatsApp"
            >
